...
baris 5 terdapat fungsi search yang mencakup baris 6-16, dengan parameter berupa data pasien, jumlah pasien, target nama yang akan dicari, dan array indeks yang akan menampung indeks urut nama yang ditemukan
