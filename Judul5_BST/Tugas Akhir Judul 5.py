...
def main():
    ...
    while True:
        print("1. Menyimpan nomor antrean pasien ke dalam struktur tree.") 
        print("2. Menampilkan nomor antrean terdekat yang lebih besar dari nomor yang dicek.") 
        print("3. Menampilkan nomor antrean terdekat yang lebih kecil dari nomor yang dicek.") 
        print("4. Menghapus nomor antrean pasien yang sudah selesai dilayani.")
        print("5. Menampilkan susunan nomor antrean dari posisi paling atas ke bawah setelah penghapusan.") 
        print("6. Keluar")
        try:
